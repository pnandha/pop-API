...
class UserSerializer(serializers.ModelSerializer):
    class Meta:
        model = User
        fields = ['id', 'name', 'email', 'mobileNumber', 'userLocation', 'userStringLocation',  'password']
        extra_kwargs = {
...
class AllUserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ['id', 'name', 'email', 'mobileNumber', 'userLocation', 'userStringLocation',  'saves', 'user_products']
